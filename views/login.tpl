...
<html lang="en" >
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
				...
				<div class="m-login__wrapper-2 m-portlet-full-height">
					<div class="m-login__contanier">
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" id="loginform" method="POST" onsubmit="do_login(); return false;">
								<div class="form-group m-form__group">
									<input class="form-control m-input" type="text" placeholder="Usuário" name="username" autocomplete="off">
								</div>
								<div class="form-group m-form__group">
		...
		<!--begin::Page Snippets -->
		<!--
		<script src="/assets/m/login.js" type="text/javascript"></script>
		-->
