...
func main() {
	...
	/*if gomode != "LOCAL" {
		...
		beego.BConfig.Listen.HTTPSCertFile = "certs/fullchain2.pem"
		beego.BConfig.Listen.HTTPSKeyFile = "certs/privkey2.pem"
	}*/
	...
	//beego.SetStaticPath("/sitemap.xml", "static/site/sitemap.xml")
	//beego.SetStaticPath("/robots.txt", "static/site/robots.txt")
